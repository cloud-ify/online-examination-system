...
//		try(FileInputStream readRegisteredStud = new FileInputStream(filename);
//				ObjectInputStream readRegStudent = new ObjectInputStream(readRegisteredStud);) {
//			
//			while (true) {
//			Student student = (Student) readRegStudent.readObject();
//			readRegisteredStudents.add(student);}
